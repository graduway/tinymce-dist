...
var modern = (function () {
  ...
  var $_dj93pju0jl265kge = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_26al5wu4jl265kgp.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_26al5wu4jl265kgp.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_fv9ja5u7jl265kh2.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_26al5wu4jl265kgp.setUiContainer(editor, panel);
  ...
  var $_985gqku1jl265kgi = { addContextualToolbars: addContextualToolbars };
  ...
  var $_8rzkwgu8jl265kh6 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_8mg4wxtzjl265kgc.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_5zau5zubjl265khu = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_8mg4wxtzjl265kgc.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_42rc5yuejl265ki0 = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_aqxozqucjl265khx.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_42rc5yuejl265ki0.fireSkinLoaded(editor));
    } else {
      $_42rc5yuejl265ki0.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_8rzkwgu8jl265kh6.createMenuButtons(editor)
            },
            $_fv9ja5u7jl265kh2.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_aqxozqucjl265khx.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_26al5wu4jl265kgp.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_5zau5zubjl265khu.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_5zau5zubjl265khu.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_8mg4wxtzjl265kgc.fireBeforeRenderUI(editor);
    ...
    $_dj93pju0jl265kge.addKeys(editor, panel);
    $_985gqku1jl265kgi.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_armud2tvjl265kg4 = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_26al5wu4jl265kgp.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_26al5wu4jl265kgp.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_1f3zedukjl265kiw = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_26al5wu4jl265kgp.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_8plov1uqjl265kk2.parseBox(settings.border);
      self$$1.paddingBox = $_8plov1uqjl265kk2.parseBox(settings.padding);
      self$$1.marginBox = $_8plov1uqjl265kk2.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_26al5wu4jl265kgp.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_8plov1uqjl265kk2.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_8plov1uqjl265kk2.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_8plov1uqjl265kk2.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_42rc5yuejl265ki0.fireSkinLoaded(editor));
    } else {
      $_42rc5yuejl265ki0.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_2ofyy4ufjl265ki2 = { render: render$1 };
  ...
  var $_fa8g6bv2jl265kli = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_fa8g6bv2jl265kli.setup(editor, theme);
    return isInline(editor) ? $_2ofyy4ufjl265ki2.render(editor, theme, args) : $_armud2tvjl265kg4.render(editor, theme, args);
  };
  var $_5ztigztrjl265kfu = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_1f3zedukjl265kiw],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_26al5wu4jl265kgp.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_8plov1uqjl265kk2.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_8plov1uqjl265kk2.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_5ztigztrjl265kfu.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_5zau5zubjl265khu.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_5zau5zubjl265khu.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_4kgd5aw5jl265kqg.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_4kgd5aw5jl265kqg.ELEMENT);
  var isText = isType$1($_4kgd5aw5jl265kqg.TEXT);
  var isDocument = isType$1($_4kgd5aw5jl265kqg.DOCUMENT);
  var $_d6q4jzw4jl265kqe = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_d6q4jzw4jl265kqe.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_d9iio8wcjl265krs = { toArray: toArray };
  ...
  var $_fk5tzzwfjl265ksi = { getOrDie: getOrDie };

  var node = function () {
    var f = $_fk5tzzwfjl265ksi.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_es4xwbwljl265kt5.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_es4xwbwljl265kt5.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_es4xwbwljl265kt5.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_4y71izwpjl265kts = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_4y71izwpjl265kts.browsers();
    var oses = $_4y71izwpjl265kts.oses();
    var browser = $_a0jjsqwojl265ktl.detectBrowser(browsers, userAgent).fold($_cjgyoqwkjl265ksz.unknown, $_cjgyoqwkjl265ksz.nu);
    var os = $_a0jjsqwojl265ktl.detectOs(oses, userAgent).fold($_30dc2dwmjl265kt7.unknown, $_30dc2dwmjl265kt7.nu);
  ...
  var $_bs7crawjjl265ksx = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_bs7crawjjl265ksx.detect(userAgent);
  });
  var $_23qytxwijl265ksr = { detect: detect$3 };

  var ELEMENT = $_4kgd5aw5jl265kqg.ELEMENT;
  var DOCUMENT = $_4kgd5aw5jl265kqg.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_dx4s7nwejl265ksf.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_23qytxwijl265ksr.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_et4pn0wdjl265kru = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_1mncycwtjl265kuf.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_et4pn0wdjl265kru.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_et4pn0wdjl265kru.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_d9iio8wcjl265krs.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_d9iio8wcjl265krs.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_1pwzmqw2jl265kq6.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_bsna0gw6jl265kqk.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_bsna0gw6jl265kqk.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_bsna0gw6jl265kqk.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_bsna0gw6jl265kqk.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_1mncycwtjl265kuf.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_d8u5gaw1jl265kpz.ancestors(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_d8u5gaw1jl265kpz.siblings(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_d8u5gaw1jl265kpz.children(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_1mncycwtjl265kuf.all(selector, scope);
  };
  var $_5sa3zcw0jl265kpx = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_5sa3zcw0jl265kpx.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_afiyrmvxjl265kom = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_afiyrmvxjl265kom.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_1pwzmqw2jl265kq6.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_et4pn0wdjl265kru.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_1mncycwtjl265kuf.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_85k0b3wzjl265kvc.ancestor(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_85k0b3wzjl265kvc.sibling(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_85k0b3wzjl265kvc.child(scope, function (e) {
      return $_1mncycwtjl265kuf.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_1mncycwtjl265kuf.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_1mncycwtjl265kuf.is, ancestor$1, scope, selector, isRoot);
  };
  var $_7ucjfywyjl265kva = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_gams8ux1jl265kw4 = { register: register };
  ...
  var $_eo5kubx3jl265kw8 = { register: register$1 };
  ...
  var $_b3imnkx4jl265kwc = { register: register$2 };
  ...
  var $_6eamafx5jl265kwf = { register: register$3 };
  ...
  var $_78zlscx6jl265kwq = { register: register$4 };
  ...
  var $_7rvq6x7jl265kws = { register: register$5 };
  ...
  var $_8kmocfx8jl265kwy = { register: register$6 };
  ...
  var $_9xwtqox9jl265kx0 = { register: register$7 };
  ...
  var $_7avv2yxajl265kx2 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_7ucjfywyjl265kva.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_78zlscx6jl265kwq.register(editor);
    $_gams8ux1jl265kw4.register(editor);
    $_8kmocfx8jl265kwy.register(editor);
    $_9xwtqox9jl265kx0.register(editor);
    $_b3imnkx4jl265kwc.register(editor);
    $_eo5kubx3jl265kw8.register(editor);
    $_6eamafx5jl265kwf.register(editor);
    $_7avv2yxajl265kx2.register(editor);
    $_7rvq6x7jl265kws.register(editor);
  };
  var $_4hl8ttwxjl265kuz = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_f49vgeuxjl265kkn,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_1hl7i7uzjl265kkx,
      Panel: Panel,
      Movable: $_1f3zedukjl265kiw,
      Resizable: $_1ypxr5v1jl265klf,
      ...
      FormatControls: $_4hl8ttwxjl265kuz,
  ...
  global.add('modern', function (editor) {
    $_4hl8ttwxjl265kuz.setup(editor);
    return $_dnx3aatqjl265kfs.get(editor);
  });
  function Theme () {
  }
