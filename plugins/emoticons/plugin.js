...
var emoticons = (function () {
  ...
  var $_emb3a5bajl265fc7 = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_emb3a5bajl265fc7.getHtml(pluginUrl);
  ...
  var $_63nx0mb9jl265fc5 = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_63nx0mb9jl265fc5.register(editor, pluginUrl);
  });
  function Plugin () {
  }
