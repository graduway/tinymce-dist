...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_g1drfnfcjl265g7j.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_g1drfnfcjl265g7j.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_g1drfnfcjl265g7j.getSelectorConverter(editor)) {
      selectorConverter = $_g1drfnfcjl265g7j.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_g1drfnfcjl265g7j.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_g1drfnfcjl265g7j.getCssGroups(editor));
      ...
      if (!$_g1drfnfcjl265g7j.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_g1drfnfcjl265g7j.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_c2mhvof7jl265g7b.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_815wq6f6jl265g78 = { get: get };

  global.add('importcss', function (editor) {
    $_c2mhvof7jl265g7b.setup(editor);
    return $_815wq6f6jl265g78.get(editor);
  });
  function Plugin () {
  }
