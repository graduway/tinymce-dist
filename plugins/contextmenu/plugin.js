...
var contextmenu = (function () {
  ...
  var $_7tr1ztavjl265fa7 = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_6esqvraujl265fa6.getContextMenu(editor);
  ...
  var $_dhl65fayjl265fac = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_6esqvraujl265fa6.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_dhl65fayjl265fac.show(editor, $_7tr1ztavjl265fa7.getPos(editor, e), visibleState, menu);
    });
  };
  var $_d9bi24atjl265fa4 = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_d9bi24atjl265fa4.setup(editor, visibleState, menu);
    return $_5ivq1wasjl265fa2.get(visibleState);
  });
  function Plugin () {
  }
